...
- Name the artifact, not the activity. Bare activity nouns ("the drafting", "the feed", "the processing") are banned: say what is produced and for what ("writes replies you approve", "new records land in the queue"). An activity word may qualify an artifact ("a draft reply") but never stand alone as the thing itself.
