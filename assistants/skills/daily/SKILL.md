...
- If the invocation includes a date (e.g. "2026-04-27"), use that.
- If the invocation includes no date, use today's date.
...
exists (the auto-generated `session-journal` note of today's coding-agent
