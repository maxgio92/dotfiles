...
Treat the text supplied with the skill invocation as the operation and its arguments.

Parse the invocation text to determine the operation:
...
Look at what follows "ingest" in the invocation text to decide scope:
...
Everything after "query" in the invocation text is the question.
